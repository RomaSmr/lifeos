// apps/web/app/analytics/AnalyticsContent.tsx
...
import { 
  BarChart3, Menu, Home, CalendarDays, Timer, 
  Target, User, FileText, Pin, PinOff, LogOut
} from 'lucide-react';
...
export default function AnalyticsContent() {
  ...
  // Если данные ещё не загрузились, показываем лоадер
  ...
  const totalStreak = habits?.reduce((acc, h) => acc + (h.streak || 0), 0) || 0;
  ...
  const chartData = getTasksByDay(14);
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              {chartData.map((day, i) => {
                const height = Math.max(2, (day.total / maxValue) * 80);
                const completedHeight = Math.max(2, (day.completed / maxValue) * 80);
